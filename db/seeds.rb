...
# Projects
p1 = Project.create!(title: 'The New Facebook', description: 'We will be making a new version of facebook, except where people post their thoughts on the current weather instead of statuses. Also, the app will sell users personal information to Samalian Pirates.', creator: u1)
p2 = Project.create!(title: 'Chinese Sushi', description: 'Have you ever thought to yourself that sushi would be better with orange chicken inside of it? Well think no longer, because Chinese Sushi is a company aimed at fuzing two foods that make absolutely no sense together. Eel and chowmein roll? Done. Sweet and sour Tiger roll? Zesty. Chicken feet inside a California roll? Serendipitous. We are the Bobby Flay of China.', creator: u2)
...
p4 = Project.create!(title: 'Whats in my Colon?', description: 'We are inventing technology that scans a persons colon, and then posts the results of that scan in real-time to their Facebook wall. No longer will you wonder what food is currently being processed in your friends digestive tract!', creator: u4)
